...
---* `"incremental"`: Change the collector mode to incremental. This option can be followed by three numbers: the garbage-collector pause, the step multiplier, and the step size (see [§2.5.1](http://www.lua.org/manual/5.4/manual.html#2.5.1)). A zero means to not change that value.
---* `"generational"`: Change the collector mode to generational. This option can be followed by two numbers: the garbage-collector minor multiplier and the major multiplier (see [§2.5.2](http://www.lua.org/manual/5.4/manual.html#2.5.2)). A zero means to not change that value.
---See [§2.5](http://www.lua.org/manual/5.4/manual.html#2.5) for more details about garbage collection and some of these options.
---
---This function should not be called by a finalizer.
---
---
---[View documents](http://www.lua.org/manual/5.4/manual.html#pdf-collectgarbage54)
---
