...
---
---Returns an iterator function. Each call to that iterator continues matching `pattern` (see [§6.4.1](http://www.lua.org/manual/5.4/manual.html#6.4.1)) over s and returns all captures.
---
...
---
---Returns a copy of s where all occurrences of `pattern` (or the first n occurrences if n is given) are replaced by repl (see [§6.4.1](http://www.lua.org/manual/5.4/manual.html#6.4.1)).
---
...
---
---Looks for the first match of `pattern` (see [§6.4.1](http://www.lua.org/manual/5.4/manual.html#6.4.1)) in the string. If it finds one, `match` returns the captures; otherwise it returns nil.
---
...
---@version >5.3
---
---Returns the length of a string resulting from `string.pack` with the given format string `fmt`. The format string cannot contain the variable-length options `s` or `z` (see [§6.4.2](http://www.lua.org/manual/5.4/manual.html#6.4.2)).
---
